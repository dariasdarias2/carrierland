function qOut = quat_mult_JPL (p, q, r )
%**************************************************************************
%function qOut = quat_mult_JPL(p,q)
%
% Date: 02.03.2018
...
%
% The quaternion is a column vector which follows the JPL convention,
% where the real part is the last component of the vector:
% p = [ px, py, pz, pw  ]' 
% 
